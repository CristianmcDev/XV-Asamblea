      ...
      <div className="card mb-3">
        <div className="row g-0">
          <div className="col-md-4">
            <img src={uni} className="img-fluid rounded m-2" alt="Hotel Selu"/>
          </div>
      ...
      <div className="card mb-3">
        <div className="row g-0">
          <div className="col-md-4">
            ...
            <iframe className=" maps mb-4" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5450.490013400694!2d-4.783173834750099!3d37.8925935638737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd6cdf65fa517245%3A0x999a213f6d4aeaee!2sHotel%20C%C3%B3rdoba%20Center!5e0!3m2!1ses-419!2ses!4v1702376705863!5m2!1ses-419!2ses" width="300" height="200" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
