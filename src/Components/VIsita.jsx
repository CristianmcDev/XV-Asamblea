import tendillas from '../assets/plaza_tendillas.jpg'
            ...
            <div className="card mb-3">
                <div className="row g-0">
                    ...
                    <div className="col-md-8">
                         <h2 className="text-center text-decoration-underline">Visitas día 26</h2>

                        <div className="card-body pt-0">
                        <h2 className="card-title">Plaza de las Tendillas</h2>

                        <p>La hora de comienzo sera a las <strong>10:00</strong> , nos repartiremos en grupos de 30 para visitar:</p>
                        <ul>
                            <li>Alcazar de los Reyes Católicos</li>
                            <li>La Juderia</li>
                            <li>La Mezquita-Catedral</li>
                            <li>Los Patios</li>
                        </ul>
                        </div>
